...
if ( ! class_exists( 'betinhouston_Customize' ) ) {
	/**
	 * Customizer Settings.
	 *
	 * @since betinhouston 1.0
	 */
	class betinhouston_Customize {
		...
		public function register( $wp_customize ) {
			...
			$wp_customize->add_control(
				...
				array(
					...
					'label'   => esc_html__( 'Display Site Title & Tagline', 'betinhouston' ),
				)
			);
			...
			$wp_customize->add_section(
				'excerpt_settings',
				array(
					'title'    => esc_html__( 'Excerpt Settings', 'betinhouston' ),
					'priority' => 120,
				)
			);
			...
			$wp_customize->add_control(
				...
				array(
					...
					'label'   => esc_html__( 'On Archive Pages, posts show:', 'betinhouston' ),
					'choices' => array(
						'excerpt' => esc_html__( 'Summary', 'betinhouston' ),
						'full'    => esc_html__( 'Full text', 'betinhouston' ),
					),
				)
			);
			...
			include_once get_theme_file_path( 'classes/class-betinhouston-customize-color-control.php' ); // phpcs:ignore WPThemeReview.CoreFunctionality.FileInclude.FileIncludeFound

			// Register the custom control.
			$wp_customize->register_control_type( 'betinhouston_Customize_Color_Control' );
			...
			$wp_customize->add_control(
				new betinhouston_Customize_Color_Control(
					$wp_customize,
					'background_color',
					array(
						'label'   => esc_html_x( 'Background color', 'Customizer control', 'betinhouston' ),
						'section' => 'colors',
						'palette' => $colors,
					)
				)
